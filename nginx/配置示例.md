...
```log
2021-10-15T14:57:18+08:00 [127.0.0.1:1234] [200] GET https://web.404z.cn/favicon.ico
```
...
- `root`路径尾部加不加`/`效果都一样，推荐不加
- 匹配`/`和`左侧带/`时，请求路径不加`/`查找路径，加了追加`index`的值
- 不要用`两侧带/`
...
- <http://localhost/> -> `/app/index.html`
- <http://localhost/test> -> `/app/test`
- <http://localhost/test/> -> `/app/test/index.html`
...
- <http://localhost/test> -> `/app/test`
- <http://localhost/test/> -> `/app/test/index.html`
- <http://localhost/test/a> -> `/app/test/a`
- <http://localhost/test/a/> -> `/app/test/a/index.html`
...
- <http://localhost/test> -> `/app/test/test`
- <http://localhost/test/> -> `/app/test/test/index.html`
- <http://localhost/test/a> -> `/app/test/test/a`
- <http://localhost/test/a/> -> `/app/test/test/a/index.html`
...
- <http://localhost/test> -> `/etc/nginx/html/test`
- <http://localhost/test/> -> `/app/test/index.html`
- <http://localhost/test/a> -> `/app/test/a`
- <http://localhost/test/a/> -> `/app/test/a/index.html`
